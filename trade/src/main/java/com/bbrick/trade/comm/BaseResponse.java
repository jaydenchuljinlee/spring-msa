...
public class BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> success(T data) { return new BaseResponse<>(true, SUCCESS_MESSAGE, data); }

    public static <T> BaseResponse<T> fail(String failMessage) { return fail(failMessage, null); }
